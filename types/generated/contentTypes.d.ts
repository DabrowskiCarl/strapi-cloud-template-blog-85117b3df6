...
export interface ApiArtykulArtykul extends Struct.CollectionTypeSchema {
...
export interface ApiKategoriaKategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Nazwa: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    Slug: Schema.Attribute.UID<'Nazwa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTransformacjaTransformacja
  ...
  info: {
    displayName: 'Transformacja';
    pluralName: 'transformacjas';
    singularName: 'transformacja';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::transformacja.transformacja'
    > &
      Schema.Attribute.Private;
    opis: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    tytulUslugi: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    zdjeciePo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    zdjeciePrzed: Schema.Attribute.Media<
